...
latex_documents = [
    (master_doc, "kubecustom.tex", "kubecustom Documentation", "kubecustom", "manual"),
]
...
man_pages = [(master_doc, "kubecustom", "KubeCustom Documentation", [author], 1)]
